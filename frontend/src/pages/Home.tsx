...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (filters.category) {
      updatedListings = updatedListings.filter(
        (listing) => listing.tags.includes(filters.category) // Filter listings by category tags
      )
    }
        ...
        <div className="bg-gray-100 p-4 sm:p-6 rounded-lg mb-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <input
              ...
              onChange={
                (e) => setFilters({ ...filters, searchTerm: e.target.value }) // Update search term filter state
              }
            ...
            <select
              ...
              onChange={
                (e) => setFilters({ ...filters, category: e.target.value }) // Update category filter state
              }
              className="p-2 border rounded-md text-black"
            >
